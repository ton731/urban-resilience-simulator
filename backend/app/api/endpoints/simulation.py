...
async def find_path(request: PathfindingRequest):
    ...
    try:
        ...
        return PathfindingResponse(
            ...
            is_partial_path=not result.success and len(result.path_coordinates) > 0,
            partial_path_reason="Road obstructions prevented reaching destination" if not result.success and len(result.path_coordinates) > 0 else None,
